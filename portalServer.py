    ...
    def do_POST(self):
        try:
            if self.path == '/addPatient':
                ...
                self.database.schedule_appointment(patient_id, doctor_id,admission_date,appointment_time)

                print("Appointment Scheduled: ", patient_id, doctor_id,admission_date,appointment_time) 
        ...
        try:
            ...
            if self.path == '/scheduleAppointment':
                ...
                self.wfile.write(b'<label for="patient_id">Patient id:</label>\
                      ...
                      <input type="date"id="appointment_time" name="appointment_time"><br><br>\
                      <input type="submit" value="Submit">\
                      </form>')
